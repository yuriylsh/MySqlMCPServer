...
var rootCommand = new RootCommand("PostgreSQL database schema introspection CLI")
{
    listSchemasCommand,
    listTablesCommand,
...
PostgresIntrospectionService BuildService()
{
    var configuration = new ConfigurationBuilder()
        ...
        .Build();
    return new PostgresIntrospectionService(configuration, NullLogger<PostgresIntrospectionService>.Instance);
}
